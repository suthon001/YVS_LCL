...
pageextension 80014 "YVS VatEntry" extends "VAT Entries"
{
    layout
    {
        addlast(Control1)
        {
            ...
            field("YVS Tax Invoice Amount"; Rec."YVS Tax Invoice Amount")
            {
                ApplicationArea = all;
            ...
            field("YVS Tax Invoice Address"; Rec."YVS Tax Invoice Address")
            {
                ApplicationArea = all;
            ...
            field("YVS Tax Invoice City"; Rec."YVS Tax Invoice City")
            {
                ApplicationArea = all;
            ...
            field("YVS Tax Invoice Post Code"; Rec."YVS Tax Invoice Post Code")
            {
                ApplicationArea = all;
