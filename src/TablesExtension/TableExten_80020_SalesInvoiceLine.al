/// <summary>
/// TableExtension YVS ExtenSales Invoice Line (ID 80020) extends Record Sales Invoice Line.
/// </summary>
tableextension 80020 "YVS ExtenSales Invoice Line" extends "Sales Invoice Line"
{
    fields
    {
