/// <summary>
/// TableExtension YVS PurchaseCr.MemoLine (ID 80033) extends Record Purch. Cr. Memo Line.
/// </summary>
tableextension 80033 "YVS PurchaseCr.MemoLine" extends "Purch. Cr. Memo Line"
{
    fields
    {
