/// <summary>
/// TableExtension YVS Invoice Post. Buffer (ID 80016) extends Record Invoice Post. Buffer.
/// </summary>
tableextension 80016 "YVS Invoice Post. Buffer" extends "Invoice Post. Buffer"
{
    fields
    {
