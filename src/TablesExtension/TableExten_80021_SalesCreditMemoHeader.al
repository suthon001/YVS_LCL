/// <summary>
/// TableExtension YVS ExtenSalesCr.MemoHeader (ID 80021) extends Record Sales Cr.Memo Header.
/// </summary>
tableextension 80021 "YVS ExtenSalesCr.MemoHeader" extends "Sales Cr.Memo Header"
{
    fields
    {
