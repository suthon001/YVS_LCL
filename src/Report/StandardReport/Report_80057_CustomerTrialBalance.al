/// <summary>
/// Report YVS Customer - Trial Balance (ID 80057).
/// </summary>
report 80057 "YVS Customer - Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80057_CustomerTrialBalance.rdl';
