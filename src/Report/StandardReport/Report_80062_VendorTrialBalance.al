/// <summary>
/// Report Vendor YVS Trial Balance (ID 80062).
/// </summary>
report 80062 "YVS Vendor Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80062_VendorTrialBalance.rdl';
