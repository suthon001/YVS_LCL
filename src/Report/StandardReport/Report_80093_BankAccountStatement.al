/// <summary>
/// Report YVS Bank Account Statement (ID 80093).
/// </summary>
report 80093 "YVS Bank Account Statement"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80093_BankAccountStatement.rdl';
