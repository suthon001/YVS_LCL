/// <summary>
/// Report YVS Inventory Order Details (ID 80075).
/// </summary>
report 80075 "YVS Inventory Order Details"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80075_InventoryOrderDetail.rdl';
