/// <summary>
/// Report YVS Bank Acc.Detail Trial Bal. (ID 80069).
/// </summary>
report 80069 "YVS Bank Acc.Detail Trial Bal."
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80069_BankDetailTrialBalance.rdl';
