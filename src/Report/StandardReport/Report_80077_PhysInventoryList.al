/// <summary>
/// Report YVS Phys. Inventory List (ID 80077).
/// </summary>
report 80077 "YVS Phys. Inventory List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80077_PhysInventoryList.rdl';
    ...
    /// Initialize.
    /// </summary>
    /// <param name="ShowQtyCalculated2">Boolean.</param>
