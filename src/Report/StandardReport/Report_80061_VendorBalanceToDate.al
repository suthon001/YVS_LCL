/// <summary>
/// Report YVS Vendor - Balance to Date (ID 80061).
/// </summary>
report 80061 "YVS Vendor - Balance to Date"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80061_VendorBalancetoDate.rdl';
