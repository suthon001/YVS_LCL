/// <summary>
/// Report YVS Aged Accounts Receivable (ID 80055).
/// </summary>
report 80055 "YVS Aged Acc. Receivable"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80055_AgedAccountsReceivable.rdl';
