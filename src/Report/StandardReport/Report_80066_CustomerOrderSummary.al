/// <summary>
/// Report YVS Customer - Order Summary (ID 80066).
/// </summary>
report 80066 "YVS Customer - Order Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80066_CustomerOrderSummary.rdl';
