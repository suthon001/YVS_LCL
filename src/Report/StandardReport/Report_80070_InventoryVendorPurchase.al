/// <summary>
/// Report YVS Inventory VendorPurchases (ID 80070).
/// </summary>
report 80070 "YVS Inventory VendorPurchases"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80070_InventoryVendorPurchase.rdl';
