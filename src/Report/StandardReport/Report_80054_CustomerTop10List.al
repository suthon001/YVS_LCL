/// <summary>
/// Report YVS Customer - Top 10 List (ID 80054).
/// </summary>
report 80054 "YVS Customer - Top 10 List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80054_CustomerTop10List.rdl';
