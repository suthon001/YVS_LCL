/// <summary>
/// Report YVS Customer - Order Detail (ID 80065).
/// </summary>
report 80065 "YVS Customer - Order Detail"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80065_CustomerOrderDetail.rdl';
