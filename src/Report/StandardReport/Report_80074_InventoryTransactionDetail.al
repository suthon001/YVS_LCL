/// <summary>
/// Report YVS Inv.Transaction Detail (ID 80074).
/// </summary>
report 80074 "YVS Inv.Transaction Detail"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80074_InventoryTransactionDetail.rdl';
