/// <summary>
/// Report YVS Aged Accounts Payable (ID 80060).
/// </summary>
report 80060 "YVS Aged Accounts Payable"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80060_AgedAccountsPayable.rdl';
