/// <summary>
/// Report Customer YVS Balance to Date (ID 80056).
/// </summary>
report 80056 "YVS Customer Balance to Date"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80056_CustomerBalancetoDate.rdl';
