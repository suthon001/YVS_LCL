/// <summary>
/// Report YVS Fixed Asset - Acquisition (ID 80091).
/// </summary>
report 80091 "YVS Fixed Asset - Acquisition"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80091_FixedAssetAcquisitionList.rdl';
    ...
    local procedure ValidateDates(pStartingDate: Date; pEndingDate: Date)
    begin
