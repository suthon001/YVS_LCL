/// <summary>
/// Report YVS Vend. Detail Trial Balance (ID 80063).
/// </summary>
report 80063 "YVS Vend. Detail Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80063_VendorDetailTrialBalance.rdl';
