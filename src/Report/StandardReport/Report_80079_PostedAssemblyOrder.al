/// <summary>
/// Report YVS Posted Assembly Order (ID 80079).
/// </summary>
report 80079 "YVS Posted Assembly Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/StandardReport/Report_80079_PostedAssemblyOrder.rdl';
