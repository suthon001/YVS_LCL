...
report 80043 "YVS WHT03 Report"
{
    ...
    local procedure AfterGetWHTProdDescriptionWHT03(var pWHTDescription: Text[100]; pWHTPostingGroup: Record "YVS WHT Product Posting Group"; pTaxWHTHeader: Record "YVS Tax & WHT Header")
    begin
    end;
