/// <summary>
/// Report YVS Purchase - Return Shipment (ID 80042).
/// </summary>
report 80042 "YVS Purchase - Return Shipment"
{
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80042_PurchaseReturnShipment.rdl';
        ...
        dataitem("Return Shipment Header"; "Return Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                begin
                    ...
                    PurchaseLine.SetRange("Document No.", "Return Shipment Header"."Return Order No.");
    ...
    /// InitializeRequest.
    /// </summary>
    /// <param name="NewNoOfCopies">Decimal.</param>
