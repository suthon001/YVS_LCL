/// <summary>
/// Report YVS AR Voucher (ID 80033).
/// </summary>
report 80033 "YVS AR Voucher (Post)"
{
    Permissions = TableData "G/L Entry" = rimd;
    Caption = 'AR Voucher';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/LCLReport/Report_80033_ARVoucherPosted.rdl';
    ...
    dataset
    {
        ...
        dataitem(SalesItemCharge; "Sales Invoice Line")
        {
    ...
    /// </summary>
    /// <param name="SalesHrd">Parameter of type Record "Sales Invoice Header".</param>
    procedure "SetGLEntry"(SalesHrd: Record "Sales Invoice Header")
    begin
