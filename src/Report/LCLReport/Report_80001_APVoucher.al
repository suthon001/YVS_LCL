/// <summary>
/// Report YVS AP Voucher (ID 80001).
/// </summary>
report 80001 "YVS AP Voucher"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("DOcument Type", "Document No.", "Line No.") where("YVS Tax Invoice No." = filter(<> ''));
        ...
        dataitem(WHTLINE; "Purchase Line")
        {
            ...
            DataItemTableView = SORTING("Document Type", "Document No.", "Line No.") where("YVS WHT Product Posting Group" = filter(<> ''));
