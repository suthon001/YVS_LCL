/// <summary>
/// Page YVS Purchase Request (ID 80036).
/// </summary>
page 80036 "YVS Purchase Request Card"
{
    ...
    SourceTableView = WHERE("Document Type" = FILTER("YVS Purchase Request"));
    ...
    layout
    {
        area(content)
        {
            ...
            part(PurchLines; "YVS Purchase Request Sub.")
            {
                ApplicationArea = Suite;
