...
page 80008 "YVS WHT Certificate"
{
    ...
    layout
    {
        ...
        area(Content)
        {
            ...
            group(BehalfInformation)
            {
                Caption = 'WHT On Behalf';
                field("On Behalf for"; rec."On Behalf for")
                {
                    ApplicationArea = all;
                    ToolTip = 'Specifies the value of the On Behalf for field.';
                }
                field("On Behalf No."; rec."On Behalf No.")
                {
                    ApplicationArea = all;
                    ToolTip = 'Specifies the value of the On Behalf No. field.';
                }
                field("On Behalf Name"; rec."On Behalf Name")
                {
                    ApplicationArea = all;
                    ToolTip = 'Specifies the value of the On Behalf Name field.';
                }
            }
            group(AddressInfor)
            {
    ...
    actions
    {
        ...
        area(Reporting)
        {
            ...
            action("WHT Certificate4CopiesBehalf")
            {
                Image = PrintReport;
                Promoted = true;
                PromotedIsBig = true;
                ...
                ApplicationArea = all;
                PromotedCategory = Report;
                Caption = 'WHT Certificate Behalf (4Copies)';
                ToolTip = 'Executes the WHT Certificate Behalf (4Copies) action.';
                trigger OnAction()
                var
                    WHTEntry: Record "YVS WHT Header";
                begin
                    WHTEntry.Copy(Rec);
                    WHTEntry.SetFilter("WHT No.", '%1', Rec."WHT No.");
                    Report.Run(Report::"YVS WHT Certificate Behalf", TRUE, TRUE, WHTEntry);
                end;
            }
        }
    }
